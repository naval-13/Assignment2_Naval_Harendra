...
class MyNetworkTopology(Topo):
    def build(self, **_opts):
        ...
        # Connection between switches and routers
        ...
        self.addLink(ra, rb, intfName1='link3', intfName2='link6', params1={'ip': '190.0.2.1/24'}, params2={'ip': '190.0.2.2/24'})
        self.addLink(rb, rc, intfName1='link7', intfName2='link8', params1={'ip': '190.0.3.1/24'}, params2={'ip': '190.0.3.2/24'})
...
if __name__ == '__main__':
    ...
    net['rb'].cmd('ip route add 190.0.1.0/24 via 190.0.3.2') 
    net['rc'].cmd('ip route add 188.0.1.0/24 via 190.0.3.1') 
    ...
    # Stop network upon CLI exit command
    net.stop()
